							 ...
							 <HeaderExpand>
										<Body className="px-4 py-4 md:px-28 md:py-8 lg:py-12 flex items-center flex-1">
											...
											<NavLink to="/"><Logo /></NavLink>
												...
												<div>
													<div className="text-4xl relative font-medium text-transparent bg-clip-text bg-gradient-to-r from-gray-700 to-gray-600 inline-block">Deep Forest AI<span className="font-normal "></span> 
														<div className="absolute top-0 ml-3 left-full bg-gradient-to-br from-green-500 to-green-500 text-white text-sm px-2 py-0.5 rounded-md font-normal hidden md:flex">gpt3</div>
													</div>
													<div className="hidden md:block text-xl text-transparent bg-clip-text bg-gradient-to-r from-gray-700 to-gray-500 inline-block">Advisor Tools</div>
													<div className="flex">
